function [J,Theta1,Theta2,Theta3,acc] = bpHw2(Theta1, Theta2, Theta3, X,y,max_iter, alpha,Lambda)
...
for q=1:max_iter
    ...
    for k=1:m
        ...
        delta2=(Theta2'*delta3(2:end)).*(a2'.*(1-a2'));        % delta(2:end) because there is no Theta1(0,j)
